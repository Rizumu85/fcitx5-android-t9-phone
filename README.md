...
- 智能英语内置更完整的英文 T9 词库，按数字序列可以预测英文单词，候选区显示完整预测词，上方输入行显示当前实际输入进度。
- 智能英语支持从实际输入中学习新单词，适合补充人名、术语和特殊词。

## 4.1.0 修复

- 在 Java 模拟器、游戏键位映射等非文本输入场景中，物理按键会透传给应用，不再被输入法误当作文字输入。
- 改善手机卡顿或发热时的长按误触：需要真正达到长按时间才触发数字、符号或候选快捷选择。
...
普通英文九键使用 multi-tap 输入。需要预测英文单词时，可以在快捷设置里切换到【智能英语】。
...
- 英文模式->支持大小写
- 智能英语模式->支持英文 T9 预测、更完整的英文词库和自动学习新词
