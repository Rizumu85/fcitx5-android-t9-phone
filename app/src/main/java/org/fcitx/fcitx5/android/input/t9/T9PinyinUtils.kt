...
object T9PinyinUtils {
    ...
    private val pinyinMap = buildMap {
        ...
        put("WGMG", "xing,ying")
        put("WGMT", "zhou")
        put("WMMG", "yong,zong,wong")
        put("AGAMG", "biang,chang")
        put("AGDMG", "cheng")
        put("AGMMG", "chong")
        put("AGTA", "chua")
        put("AGTAG", "chuai")
        ...
        put("GTAG", "guai,huai")
        put("GTAM", "guan,huan")
        put("GTAMG", "guang,huang")
        put("JGMMG", "jiong")
        put("JTAM", "kuan,luan,juan,lvan")
        put("JTAMG", "kuang")
        put("JTAG", "kuai")
        put("MGA", "nia")
        put("MGAMG", "niang")
        put("MMMG", "nong")
        put("MTAM", "nuan")
        put("PGAMG", "qiang,shang")
        put("PGMMG", "qiong")
        put("PTAM", "quan,ruan,suan")
        put("PMMG", "rong,song")
        put("PTA", "rua")
        put("PGDG", "shei")
        put("PGDMG", "sheng")
        ...
        put("PGTM", "shun,shuo")
        put("TTAM", "tuan")
        put("WGAMG", "xiang,zhang")
        put("WGMMG", "xiong,zhong")
        put("WGDG", "zhei")
        put("WGDMG", "zheng")
        put("WGTA", "zhua")
        put("WGTAG", "zhuai")
